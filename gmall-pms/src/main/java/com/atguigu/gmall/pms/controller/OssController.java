...
public class OssController {
    ...
    public Resp<Object> policy(){
        String accessId = "LTAI4G9yJTxGg9bEbG7W8St8"; // 请填写您的AccessKeyId。
        String accessKey = "Gonxzg6y1AldoQzbEr8u5H0eK3BLRb"; // 请填写您的AccessKeySecret。
        String endpoint = "oss-cn-chengdu.aliyuncs.com"; // 请填写您的 endpoint。
        String bucket = "gmall-two"; // 请填写您的 bucketname 。
