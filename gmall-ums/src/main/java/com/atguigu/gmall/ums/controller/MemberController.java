...
public class MemberController {
    ...
    @GetMapping("query")
    public Resp<MemberEntity> queryUserByPad(@RequestParam("username")String username,
    @RequestParam("password")String password){
        MemberEntity memberEntity =  this.memberService.queryUserByPad(username,password);
        return Resp.ok(memberEntity!=null ? memberEntity : new MemberEntity());
    }
    ...
    public Resp<Object> register(MemberEntity memberEntity,@RequestParam("code")String code){
        ...
        return Resp.ok(this.memberService.register(memberEntity,code));
    }
    ...
    public Resp<Boolean> checkData(@PathVariable("data")String data,
